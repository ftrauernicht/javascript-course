...
[← Back to course overview](../../../README.md) · Related: [Course 3 – Calculator GUI](../../03-calculator-gui/en/01-calculator-gui.md), [Course 4 – To-Do List](../../04-todo-list/en/01-todo-list.md) (neither required, though if you've done either, the DOM parts below will feel familiar)
...
*(If you've done Course 3 or Course 4, all of this will be familiar, so skip ahead to the next section.)*
...
- [`.forEach(...)`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/forEach)
  runs a function once for every item in an array; here, that's once per
  unit name, instead of writing one line per unit by hand.
...
Convert 5 meters into kilometers, and you should get 0.01:
