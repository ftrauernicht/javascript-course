...
[← Zurück zur Kursübersicht](../../../README.de.md) · Verwandt: [Kurs 3 – Taschenrechner GUI](../../03-calculator-gui/de/01-taschenrechner-gui.md), [Kurs 4 – To-Do-Liste](../../04-todo-list/de/01-to-do-liste.md) (keiner davon nötig, falls du aber einen gemacht hast, werden dir die DOM-Teile weiter unten vertraut vorkommen)
...
Anweisungen umschließt, ist hier jeder Schlüssel ein Einheitenname und
...
rundet eine Zahl auf 2 Nachkommastellen und gibt sie als Text zurück. Ohne
das würde eine Umrechnung wie 1 mi in km eine lange, hässliche
