...
[← Back to repository overview](README.md) · Comes after: [Course 2 – Calculator Console](courses/02-calculator-console/en/01-calculator-console.md), [Course 3 – Calculator GUI](courses/03-calculator-gui/en/01-calculator-gui.md), [Course 4 – To-Do List](courses/04-todo-list/en/01-todo-list.md), [Course 5 – Unit Converter](courses/05-unit-converter/en/01-unit-converter.md), [Course 6 – Quiz](courses/06-quiz/en/01-quiz.md), [Course 7 – Memory Game](courses/07-memory-game/en/01-memory-game.md), [Course 8 – Weather App](courses/08-weather-app/en/01-weather-app.md), [Course 9 – Budget Tracker](courses/09-budget-tracker/en/01-budget-tracker.md), and [Course 10 – REST API](courses/10-rest-api/en/01-rest-api.md)

# Ideas for your next projects

Courses 2 through 10 (the calculator, twice over, a to-do list, a unit
converter, a quiz, a memory game, a weather app, a budget tracker, and a
REST API) cover the fundamentals in depth — variables, functions, the
DOM, rendering data as HTML, a first step into OOP, talking to a real
API, and running JavaScript outside the browser. What comes after is up
to you: here's a ranked list of project ideas, roughly ordered from
...
could become this repository's Course 11 — or just your own side
project.
...
Whichever you pick, the same habits from Courses 2 through 10 still apply: build the
